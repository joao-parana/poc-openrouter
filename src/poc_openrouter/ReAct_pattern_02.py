...
# The previous process described in ReAct_pattern_01.py was tedious and manual.
# We can automate the process by creating a loop of a total number of steps `max_turns=5`
...
# Adding a loop. Now we add a loop to do a flow automation
...
def query(question, max_turns=5):
    ...
    while i < max_turns:
        ...
        if actions:
            ...
            print(" -- running {} {}".format(action, action_input), flush=True)
